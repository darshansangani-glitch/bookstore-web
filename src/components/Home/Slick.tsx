          ...
          <SwiperSlide>
            ...
            >
              <div className="w-full inset-0  backdrop-blur-xs h-200 absolute flex flex-1 justify-evenly items-center ">
                <div
                  className={`w-140 h-26.5 text-[#222222] font-prata flex flex-col gap-10`}
                >
                  {card.title ? (
                    <span className="text-[73px] font-prata font-bold ">
                      {card.title ? card.title : ""}
                    </span>
                  ) : null}
                  {card.title && (
                    <button className="w-50 h-25 p-4 text-[16px] gap-2 hover:gap-5 text-[#111111] border border-[#C0C0C0] items-center flex justify-center hover:bg-[#5b4f29] hover:text-white" onClick={() => navigate('/books')}>
